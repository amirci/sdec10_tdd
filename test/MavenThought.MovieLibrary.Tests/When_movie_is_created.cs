...
namespace MavenThought.MovieLibrary.Tests
{
    ...
    public class When_movie_is_created : MovieSpecification
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="When_movie_is_created"/> class.
        /// </summary>
        /// <param name="title">Title for the movie</param>
        /// <param name="releaseDate">Date to release</param>
        public When_movie_is_created([RandomStrings(Count=5, Pattern="The great [A-Za-z]{8}")]string title,
        ...
        /// </summary>
        /// <returns></returns>
        protected static IEnumerable<DateTime> RandomDates()
        {
            for (var i = 0; i < 5; i++)
            {
